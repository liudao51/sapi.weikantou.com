 ...
 */
class RegionService extends BService
{
    private $_regionDao;

    public function __construct()
    {
        $this->_regionDao = new RegionDao();
    }
    ...
    public function getRegionById($region_id)
    {
        ...
        $region = $this->_regionDao->getRegionById($region_id);
    ...
    public function getSubRegionsById($pid, $rank = 1)
    {
        ...
        $subRegions = $this->_regionDao->getSubRegionsById($pid, $rank);
    ...
    public function getRegionsByName($region_name, $level = -1)
    {
        ...
        $relateRegions = $this->_regionDao->getRegionsByName($region_name, $level);
